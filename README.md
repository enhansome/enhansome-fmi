...
* **Examples**:
  * [Reference-FMUs](https://github.com/modelica/Reference-FMUs) ⭐ 226 | 🐛 43 | 🌐 C | 📅 2026-09-12 : `3.0` examples FMUs are available, including examples for new co-simulation features such as scheduled co-simulation and early return in co-simulation.
