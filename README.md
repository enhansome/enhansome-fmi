...
You can find the text of the FMI specification 2.0.4 at <https://github.com/modelica/fmi-standard/releases/tag/v2.0.4> ⭐ 358 | 🐛 42 | 🌐 C | 📅 2026-09-08 .
...
* [FMI Library](https://github.com/modelon-community/fmi-library) ⭐ 158 | 🐛 29 | 🌐 C | 📅 2026-07-03 - C library for import of FMUs. \[BSD]
...
* [FMPy](https://github.com/CATIA-Systems/FMPy) ⭐ 584 | 🐛 134 | 🌐 Python | 📅 2026-09-09 - Python package for loading and interacting with FMUs. It supports also the latest [System Structure and Parameterization (SSP standard)](https://www.modelica.org/projects). \[BSD]
* [PyFMI](https://github.com/modelon-community/pyfmi) ⭐ 226 | 🐛 17 | 🌐 Python | 📅 2026-09-08 - Python package for loading and interacting with FMUs, based on the FMI Library. \[LGPL]
...
* **Python:**
  * [fmpy](https://github.com/CATIA-Systems/FMPy) ⭐ 584 | 🐛 134 | 🌐 Python | 📅 2026-09-09 - support for FMI `3.0` is available.
* **Julia:**
